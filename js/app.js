(() => {
    ...
    const bodyLock = function() {
        ...
        if (bodyLockStatus) {
            let lockPaddings = document.querySelectorAll("[data-lp]");
            for (const lockPadding of lockPaddings) lockPadding.style.paddingRight = window.innerWidth - wrapperWidth + "px";
            body.style.paddingRight = window.innerWidth - wrapperWidth + "px";
    ...
    const menuInit = () => {
        ...
        if (iconMenu) document.addEventListener("click", (e => {
    ...
    const headerScroll = () => {
        ...
        document.addEventListener("windowScroll", (() => {
            ...
            if (scrollTop >= startPoint) !header.classList.contains("header-scroll") ? header.classList.add("header-scroll") : null; else header.classList.contains("header-scroll") ? header.classList.remove("header-scroll") : null;
        }));
    };
    setTimeout((() => {
    ...
    let swiper = null;
    const initSliders = () => {
        if (document.querySelector(".slider-materials")) swiper = new Swiper(".slider-materials", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
